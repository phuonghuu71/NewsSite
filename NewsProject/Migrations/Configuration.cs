namespace NewsProject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NewsProject.Models.NewsSite>
    {
        ...
        protected override void Seed(NewsSite context)
        {
            ...
            context.WebInfo.AddOrUpdate( x =>x.id,
                ...
                {
                    id = 1,
                    web_name = "Tin tức Games",
                    web_des = "Trang web chính thức của Tin tức Games",
                    web_about = "Về Tin tức Games",
                }
                );
