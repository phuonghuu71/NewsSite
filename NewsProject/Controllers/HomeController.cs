...
namespace NewsProject.Controllers
{
    ...
    {
        UnitOfWork db = new UnitOfWork(new NewsSite());
        ...
        public ActionResult ViewPost(string title)
        {
            ...
            {
                String getUrl = System.Web.HttpContext.Current.Request.Url.PathAndQuery;
                TempData["GetUrl"] = getUrl;
        ...
        public ActionResult Category(int? id, int? page)
        {
            if(id!=null)
            {
                ...
                if (tag != null)
                {
                    using (NewsSite conn = db.Context)
                    {
                        var result = (
